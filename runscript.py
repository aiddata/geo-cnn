...
def build_dataloaders(df_dict, base_path, imagery_type, imagery_bands, data_transform=None, dim=224, batch_size=64, num_workers=16, agg_method="mean", shuffle=True):
    ...
    for group in df_dict:
        tmp_dset = BandDataset(df_dict[group], base_path, imagery_type, imagery_bands, dim=dim, transform=data_transform, agg_method=agg_method)
